...
class PromoCodeVC: UIViewController, UITextFieldDelegate {
    ...
    func setupNavigationBar(){
        ...
        navigationController?.navigationBar.topItem?.title = "Веедите промо Коды:"
    ...
    let promoCodeInput: UITextField = {
        ...
        input.placeholder = "Веедите промо Коды:"
        input.title = "Веедите промо Коды:"
        input.translatesAutoresizingMaskIntoConstraints = false
        return input
    }()
    let applyBtn: UIButton = {
        var btn = UIButton()
        btn.setTitle("Подверждение", for: .normal)
